...
module.exports = function () {
    ...
    mobileMethod.goTop = function () {
        ...
        var scrollMove = function scrollMove(scrollTo, time) {
    ...
    mobileMethod.weiXinPay = function (data, showMask, hideMask) {
        ...
        //调用微信中微信支付的接口
        var jsApiCall = function jsApiCall() {
...
module.exports = function () {
    ...
    $(function () {
        ...
        var BindHeadEvent = function BindHeadEvent() {
            this.init();
        };
        ...
        BindHeadEvent.prototype = {
            ...
            bindEvent: function bindEvent() {
                ...
                $(".xiala").click(function () {
                    ...
                    if (kdAlert.length < 1) {
                        var temp = '<div class="kd-alert">' + '<div class="alert-content">' + '<a href="/"><i class="shouye"></i><span>银泰首页</span></a>' + '<a href="/Category"><i class="fenleiye"></i><span>分 类</span></a>' + '<a href="/Cart"><i class="gouwudai"></i><span>购物车</span></a>' + '<a href="/UserCenter" class="no-border"><i class="wode"></i><span>我的银泰</span></a></div></div>';
	...
	$.fn.alert = function (opt, optCss) {
		...
		var _defaultCss = {
			alert: (_alert = {
				...
				'top': 0,
				'display': '-webkit-flex'
			}, _defineProperty(_alert, 'display', 'flex'), _defineProperty(_alert, 'justify-content', 'center'), _defineProperty(_alert, 'align-items', 'center'), _defineProperty(_alert, 'display', '-webkit-box'), _defineProperty(_alert, '-webkit-box-orient', 'horizontal'), _defineProperty(_alert, '-webkit-box-align', 'center'), _defineProperty(_alert, '-webkit-box-pack', 'center'), _defineProperty(_alert, 'background-color', 'rgba(0, 0, 0, .5)'), _defineProperty(_alert, 'z-index', '9999'), _alert),
			content: {
				'width': '80%',
				'max-width': '360px',
				'border-radius': '6px',
		...
		var _removeAlert = function _removeAlert() {
			$alert.remove();
...
var AuthorizeAjax = __webpack_require__(3)();
...
$(function () {
    ...
    UserCenter.prototype = {
         ...
         * @return 无
         */
        collectNodes: function collectNodes() {
         ...
         * @return null
         */
        queryUserAccount: function queryUserAccount() {
            var self = this;
         ...
         * @return 无
         */
        tipBox: function tipBox(body, type, fn) {
            $('body').alert({
                body: body,
                type: type,
                callback: fn
