...
module.exports = {
                 ...
                 */
                swipe: function swipe(container, options) {
                                "use strict";
...
$(function () {
    ...
    HomePage.prototype = {
         ...
         * @return 无
         */
        countDown: function countDown(curNode, _leftTime, i) {
            var time = null,
                renderTime = [],
                countTmp = '';
        ...
        * @return null
        */
        carouselBanner: function carouselBanner() {
            var self = this;
            ...
            for (var i = 0; i < bannercount.length; i++) {
                ...
                if (thisBanner) {
                    Swipe.swipe(thisBanner, {
                        callback: function callback(index, node) {
